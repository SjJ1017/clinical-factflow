...
def main():
 ...
 result={'passed':True,'pdf_files':22,'pages_including_duplicate_exports':pages,'master_pages':22,'embedded_raster_images':images,'out_of_page_text':len(outside),'trace_round_token_curves':len(clock['runs']),'token_endpoint_checks':480,'api_calls':0}
